...
impl DescriptorWriter<'_> {
    ...
    pub fn interface(
        ...
        self.interface_with_alternate_setting(
            number,
            interface_class,
            interface_sub_class,
            interface_protocol,
    ...
    /// Writes a interface descriptor with an alternate setting value
    ///
    /// # Arguments
    ///
    /// * `number` - Interface number previously allocated with
    ...
    /// * `interface_sub_class` - Sub-class code. Depends on class.
    /// * `interface_protocol` - Protocol code. Depends on class and sub-class.
    pub fn interface_with_alternate_setting(
        &mut self,
        number: InterfaceNumber,
        interface_class: u8,
        interface_sub_class: u8,
    ...
    pub fn endpoint<'e, B: UsbBus, D: EndpointDirection>(
        ...
        self.write(
            ...
            &[
                ...
                endpoint.ep_type() as u8 | endpoint.ep_sync_type() as u8, // bmAttributes
                mps as u8,
